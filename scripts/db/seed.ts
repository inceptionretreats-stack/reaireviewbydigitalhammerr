 ...
 *    with no row here resolves to nothing at all (apps/web/lib/customer/public-business.ts);
 ...
 *
 * Run: `pnpm tsx scripts/db/seed.ts [--force]`
 */
...
export function loadSpecDocuments(
  ...
  return {
    ...
    currentPrompt: parsePromptTemplate(
      ...
      `scripts/db/prompt-versions/${currentFile}`,
    ),
  };
}
