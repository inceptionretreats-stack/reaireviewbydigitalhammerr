 ...
 *
 *   node scripts/dev/tunnel.mjs          # tunnels http://localhost:3000
 *   node scripts/dev/tunnel.mjs 3001     # or another port
 *
 ...
 * CSRF origin allowlist (apps/web/lib/http/csrf.ts), so the dashboard keeps working at the new host.
 *
