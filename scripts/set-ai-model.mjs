 ...
 *
 *   node scripts/set-ai-model.mjs claude-haiku-4-5
 *   node scripts/set-ai-model.mjs claude-haiku-4-5 --effort ''
 *   node scripts/set-ai-model.mjs --show
 *
...
if (!show && !model) {
  console.error('Usage: node scripts/set-ai-model.mjs <model-id> [--effort <value>] | --show');
  process.exit(1);
}
