...
const captionSource = path.join(workspace, 'scripts/media/assets/hero-review-walkthrough-v2.vtt');
const width = 960;
const height = 960;
const fps = 30;
const duration = 30;
