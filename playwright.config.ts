...
/**
 * End-to-end suite (docs/spec/12_QA_Acceptance_Criteria.md "Required automated test suites").
 *
 ...
 *
 * The suite starts nothing itself. It needs a running dev server and a migrated, seeded
 * database; setup and commands are in e2e/README.md ("What it needs"). Loading .env above
 * affects only this test process, not the migrate and seed commands.
 */
export default defineConfig({
  ...
  projects: [
    ...
    {
      // The customer half is mobile-first by specification
      // (docs/spec/18_UI_UX_Design_System_Brief.md), and a QR scan is by definition a phone.
      // Testing it on a desktop viewport only would miss exactly the layout the product is
      // designed around.
      name: 'mobile',
