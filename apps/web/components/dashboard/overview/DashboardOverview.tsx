 ...
 * `app/(vendor)/onboarding/layout.tsx` already draws. Nothing in this tree takes a business id from
  ...
  return (
    <div className="vendor-overview flex flex-col gap-6">
      ...
      {/* The lifecycle state goes in because a count of enabled sources says nothing about whether
          any of them resolves: only an ACTIVE business does (lib/customer/public-business.ts, Flow J). */}
      <LiveFigures
 ...
 *
 * `lib/tenant/require-tenant.ts` calls this a broken invariant rather than a normal state, and it is:
