...
export function PromptExplanation() {
  return (
    <Card>
      <details>
        <summary className="min-h-11 cursor-pointer content-center rounded text-ink focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-accent">
          <h2 className="inline text-base font-semibold">How your details are used</h2>
        </summary>
        <div className="pt-3">
          <ol className="flex list-decimal flex-col gap-2 pl-5 text-sm text-ink">
            <li>
              Your business name, category and city go in as plain facts, so a draft is about the
              right kind of business in the right place.
            </li>
            <li>
              Your summary, services and context terms are background. A draft uses at most one or
              two of them, worked into normal sentences — and sometimes none, because a list of
              terms in a review reads like an advertisement.
            </li>
            <li>
              The mode in use decides which of those topics gets the emphasis. It changes the
              subject, not the sentiment.
            </li>
            <li>
              Your draft language decides whether it is written in Hinglish or in English. The words
              are still the customer&apos;s to change.
            </li>
            <li>
              The draft stays deliberately unspecific about anything nobody has told us: no waiting
              times, prices, staff names, or results. Your customer knows those things; we do not,
              and inventing them would put words in their mouth.
            </li>
            <li>
          ...
          <div className="mt-4 border-t border-line pt-3">
            <p className="text-sm text-ink-muted">
              ...
              honest and inside the review platforms&rsquo; own policies — which is what protects
              your page in the long run. What you control is the context above, and that is the part
              that makes a draft sound like your business.
            </p>
          </div>
        </div>
      </details>
