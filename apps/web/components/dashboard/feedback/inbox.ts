 ...
 * As with `components/dashboard/summary.ts`, it is plain server-side data access that belongs in
 * `apps/web/lib/`; it lives here because of how this build is split across concurrent
 * workstreams.
 *
 * ## FB-02-01 / AC-003
 *
