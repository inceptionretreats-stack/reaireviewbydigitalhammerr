...
import { DEFAULT_TEMPLATE_TEXT, findTrackedRequestUrl } from '@/lib/crm/review-requests/template';
import {
 ...
 * state, the same division `app/(vendor)/app/page.tsx` draws for DASH-01.
 *
 ...
 *
 * No link to the customer list: `components/dashboard/shell/nav-items.ts` shows CRM-01 as planned rather
 ...
 * signup creates the business in the same transaction as the user (see `lib/tenant/require-tenant.ts`).
