 ...
 * "Copied" is still true a minute later. Same reasoning as `components/dashboard/overview/CopyLinkButton.tsx`.
 */
 ...
 * shown verbatim rather than remapped here — the same decision `components/shared/forms/use-form-submit.ts`
