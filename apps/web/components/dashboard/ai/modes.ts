import { MODE_NAME_MAX } from '../../../app/api/v1/ai/modes/schema';
 ...
 * API start disagreeing about what a mode is. The imports are relative rather than `@/`-aliased
 * because the Vitest unit suite resolves no path aliases, and a helper that cannot be imported by a
 * test is a helper with no tests.
 *
