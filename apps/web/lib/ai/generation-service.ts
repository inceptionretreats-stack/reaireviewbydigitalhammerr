 ...
 *
 * The review page always opens on the service picker; a customer creates a draft explicitly, and a
 * draft they already have is offered through "Return to draft". Remembering it is what keeps a
 * refresh or a rescan from spending another generation — on the free plan a business has ten for
 * its lifetime.
 *
