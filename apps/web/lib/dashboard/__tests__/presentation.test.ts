...
describe('describeQrSources', () => {
  ...
  it('never tells a suspended or closed tenant that its sources are working', () => {
    // The regression this exists for: lib/customer/public-business.ts resolves a QR only for an ACTIVE
...
describe('describeBusinessStatus', () => {
  it('treats only ACTIVE as publicly live, the way lib/customer/public-business.ts does', () => {
