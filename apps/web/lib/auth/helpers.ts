 ...
 */
// Re-exported from lib/tenant/tenant-shell so server call sites need no change. The definitions moved
...
export { SHELL_CATEGORY, isShell, shellBusinessName } from '../tenant/tenant-shell';
