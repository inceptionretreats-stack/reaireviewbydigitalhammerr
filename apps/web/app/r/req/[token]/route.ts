...
import { looksLikeLinkPreviewFetch } from '@/app/api/v1/review-requests/link-preview';
import { isTrackingTokenFormat } from '@/app/api/v1/review-requests/template';
import {
...
export async function GET(
   ...
   * that no longer exists. Every other public entry point already refuses: `lib/public-business.ts`
