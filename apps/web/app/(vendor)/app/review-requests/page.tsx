...
import { RequestsSkeleton } from '@/components/dashboard/review-requests/RequestsSkeleton';
import { ReviewRequestsScreen } from '@/components/dashboard/review-requests/ReviewRequestsScreen';
 ...
 * would never render — the same division `app/(vendor)/app/page.tsx` makes for DASH-01.
 *
